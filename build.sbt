...
lazy val neptunium = (project in file(".")).settings(
  ...
  libraryDependencies += "org.scalaz.stream" % "scalaz-stream_2.12" % "0.8.6",
  libraryDependencies += "org.scalaz" % "scalaz-core_2.12" % "7.2.7",

  libraryDependencies += "com.jsuereth" % "scala-arm_2.12" % "2.0",

  libraryDependencies += "org.log4s" % "log4s_2.12" % "1.3.3",
